...
# Train KNN model
knn_model = train_model(X_train_resampled, y_train_resampled)
...
image_path = r"C:\Users\amans\OneDrive\Documents\GitHub\stat_sem2_project\sample images\1\im__10.png"
img = cv2.imread(image_path)
